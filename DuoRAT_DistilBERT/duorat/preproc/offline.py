...
#from duorat.utils.tokenization import AbstractTokenizer, BERTTokenizer, DistilBERTTokenizer
from duorat.utils.tokenization import AbstractTokenizer, DistilBERTTokenizer
...
class BertDuoRATPreproc(DuoRATPreproc):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        assert isinstance(self.tokenizer, DistilBERTTokenizer)
...
@registry.register("preproc", "DistilBertDuoRAT")
class DistilBertDuoRATPreproc(DuoRATPreproc):
    tokenizer: DistilBERTTokenizer

    def __init__(self, **kwargs) -> None:
        super(DistilBertDuoRATPreproc, self).__init__(**kwargs)
        self.add_cls_token = kwargs["add_cls_token"]
        self.add_sep_token = kwargs["add_sep_token"]

        print(self.tokenizer)  # DEBUG
    ...
    def save(self) -> None:
        super(DistilBertDuoRATPreproc, self).save()

    def load(self) -> None:
        super(DistilBertDuoRATPreproc, self).load()
