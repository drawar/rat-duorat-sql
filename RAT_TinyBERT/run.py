...
from ratsql.commands import eval
from ratsql.commands import infer
from ratsql.commands import preprocess
from ratsql.commands import train
...
def main():
    ...
    parser.add_argument(
        'mode', help='preprocess/train/eval',
    ...
    if args.mode == 'preprocess':
        preprocess_config = PreprocessConfig(
            model_config_file, model_config_args,
        )
